...
const modules = [
  {
    ...
    body: "Hammadde, yarı mamul ve bitmiş ürünü tek depoda ya da çoklu lokasyonda gerçek zamanlı izleyin. Teklif onaylandığı anda stok otomatik düşer, kritik seviyede uyarı verir.",
    note: "Örn. 1.240 kalem · 6 depo · gerçek zamanlı senkron",
    span: "md:col-span-4",
  },
  {
    code: "MOD.02",
    icon: ReceiptText,
    title: "Dinamik Teklif Yönetimi",
    body: "Karmaşık ürün konfigürasyonlarını saniyeler içinde fiyatlandırın, profesyonel teklif çıktıları oluşturun, revizyon geçmişini tek ekrandan takip edin.",
    note: "Örn. Konfigürasyon → fiyat → onay, tek akış",
    span: "md:col-span-2",
  },
  {
    code: "MOD.03",
    icon: TrendingUp,
    title: "Uçtan Uca Satış Süreci",
    body: "Teklif onayından sipariş takibine, faturalandırmadan teslimat durumuna kadar tüm satış hattını tek panelden yönetin.",
    note: "Örn. Onay oranı, ort. kapanış süresi",
    span: "md:col-span-2",
  },
  {
    code: "MOD.04",
    ...
    body: "Müşteri geçmişini, iletişim kayıtlarını ve fırsat hattını satış ve teklif verileriyle aynı sistemde birleştirin — her müşteri için tek doğru kaynak.",
    note: "Örn. Fırsat hattı, iletişim geçmişi, hatırlatmalar",
    span: "md:col-span-4",
  },
];

const flow = [
  { n: "01", title: "Ürün Tanımı", body: "Ürün ve konfigürasyon kuralları sisteme tanımlanır." },
  { n: "02", title: "Teklif Oluştur", body: "Müşteriye özel fiyatlandırma saniyeler içinde hazırlanır." },
  { n: "03", title: "Onay & Satış", body: "Teklif onaylanır, sipariş satış hattına düşer." },
  { n: "04", title: "Stok Güncellemesi", body: "İlgili stok kalemleri otomatik olarak düşer." },
  { n: "05", title: "CRM Kaydı", body: "Müşteri geçmişine işlenir, sonraki fırsat izlenir." },
];
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="rounded-sm border border-line-500/40 bg-ink-800 p-2">
              <Layers className="h-5 w-5 text-line-400" />
            </div>
      ...
      <main>
          ...
          <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 md:grid-cols-2 md:py-28">
            <div className="flex flex-col justify-center">
              <h1 className="font-display-blueprint text-4xl font-semibold leading-[1.08] tracking-tight text-white sm:text-5xl lg:text-[3.4rem]">
                Stoktan satışa, tek çizim üzerinde yönetin.
              </h1>
              <p className="mt-6 max-w-xl text-lg leading-relaxed text-slate-400">
                Adapsis; stok, teklif, satış ve müşteri ilişkilerini tek bir operasyon
                şemasında birleştirir. Hammadde, parça ya da bitmiş ürün — her türden
                ürün için geçerli.
              </p>
              ...
              <p className="mt-8 font-mono-blueprint text-[12px] leading-relaxed text-slate-500">
                {"// Admin ve Satış ekipleri için ayrı yetkilendirilmiş arayüzler"}
              </p>
            </div>
            ...
            <div className="flex items-center justify-center">
              <svg
                ...
                role="img"
                aria-label="Stok, teklif, satış ve CRM modüllerini birbirine bağlayan operasyon şeması"
              >
                <defs>
                ...
                <g>
                  ...
                  <text x="50" y="93" className="font-display-blueprint" fontSize="20" fontWeight="600" fill="#f8fafc">STOK</text>
                  <text x="50" y="112" fontSize="11.5" fill="#94a3b8">Gerçek zamanlı envanter takibi</text>
                  ...
                  <text x="388" y="86" className="font-mono-blueprint" fontSize="11" fill="#64748b">1.240 KALEM</text>
                </g>
                ...
                <g>
                  ...
                  <text x="160" y="233" className="font-display-blueprint" fontSize="20" fontWeight="600" fill="#f8fafc">TEKLİF</text>
                  <text x="160" y="252" fontSize="11.5" fill="#94a3b8">Dinamik fiyatlandırma</text>
                  ...
                  <text x="498" y="226" className="font-mono-blueprint" fontSize="11" fill="#64748b">₺48,2K AÇIK</text>
                </g>
                ...
                <g>
                  ...
                  <text x="50" y="373" className="font-display-blueprint" fontSize="20" fontWeight="600" fill="#f8fafc">SATIŞ</text>
                  <text x="50" y="392" fontSize="11.5" fill="#94a3b8">Uçtan uca sipariş hattı</text>
                  ...
                  <text x="388" y="366" className="font-mono-blueprint" fontSize="11" fill="#64748b">312 SİPARİŞ/AY</text>
                </g>
                ...
                <g>
                  ...
                  <text x="160" y="513" className="font-display-blueprint" fontSize="20" fontWeight="600" fill="#f8fafc">CRM</text>
                  <text x="160" y="532" fontSize="11.5" fill="#94a3b8">Müşteri ilişkileri yönetimi</text>
                  ...
                  <text x="498" y="506" className="font-mono-blueprint" fontSize="11" fill="#a1a1aa">86 AKTİF FIRSAT</text>
                </g>
              </svg>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="mb-14 max-w-2xl">
              ...
              <p className="mt-4 text-lg leading-relaxed text-slate-400">
                Dört modül, tek şema. Her biri kendi başına çalışır, hepsi birbirine bağlı veri üzerinden konuşur.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-px border border-line-500/15 bg-line-500/10 md:grid-cols-6">
              {modules.map((m) => (
                ...
                >
                  ...
                  <h3 className="font-display-blueprint text-2xl font-semibold text-white">{m.title}</h3>
                  <p className="mt-3 max-w-md leading-relaxed text-slate-400">{m.body}</p>
        ...
        <section id="surec" className="border-b border-line-500/15 bg-ink-900/40 px-6 py-24">
          <div className="mx-auto max-w-7xl">
            <div className="mb-14 max-w-2xl">
              ...
              <p className="mt-4 text-lg leading-relaxed text-slate-400">
                Ürün tanımından müşteri kaydına, tüm adımlar tek akış içinde birbirini tetikler.
              </p>
            </div>
        ...
        <section id="guvenlik" className="border-b border-line-500/15 px-6 py-24">
          <div className="mx-auto grid max-w-7xl gap-12 md:grid-cols-2 md:items-center">
            <div>
              <h2 className="font-display-blueprint text-3xl font-semibold tracking-tight text-white sm:text-4xl">
                Rol Bazlı Erişim, Uçtan Uca Güvenlik
              </h2>
              <p className="mt-4 text-lg leading-relaxed text-slate-400">
                Satır seviyesinde güvenlik kuralları (RLS) ile Admin ve Satış ekiplerinin
                görebildiği veriyi ayırın. Her kullanıcı yalnızca yetkili olduğu şemaya erişir,
                geri kalanı görünmez kalır.
              </p>
            </div>

            <div className="flex items-center justify-center gap-3 sm:gap-6">
              {[
                { icon: Users, label: "ADMIN / SATIŞ" },
                { icon: Lock, label: "RLS KAPISI" },
                { icon: Database, label: "VERİ" },
              ].map((node, i) => (
        ...
        <section className="relative overflow-hidden px-6 py-24">
          ...
          <div className="relative mx-auto flex max-w-4xl flex-col items-center border border-line-500/20 bg-ink-900/70 px-8 py-16 text-center">
            ...
            <h2 className="font-display-blueprint text-3xl font-semibold tracking-tight text-white sm:text-4xl">
              Operasyonunuzu bugün tek şemaya taşıyın.
            </h2>
            <p className="mt-4 max-w-xl text-lg leading-relaxed text-slate-400">
              Stoktan CRM&apos;e, tüm süreçlerinizi yöneten platforma giriş yapın.
            </p>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 divide-y divide-line-500/15 sm:grid-cols-2 sm:divide-x sm:divide-y-0">
          <div className="flex items-center gap-3 px-6 py-6">
            <div className="rounded-sm border border-line-500/40 bg-ink-800 p-1.5">
              <Layers className="h-4 w-4 text-line-400" />
            </div>
            <p className="text-sm text-slate-500">
              Her türden ürün için stok, teklif, satış ve müşteri yönetimi.
            </p>
          </div>
